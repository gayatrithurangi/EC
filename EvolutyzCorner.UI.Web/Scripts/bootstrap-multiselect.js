    ...
    Multiselect.prototype = {
        ...
        defaults: {
            ...
            buttonText: function(options, select) {
                if (options.length === 0) {
                    return this.nonSelectedText + ' <i class="ion ion-ios-arrow-down"></i>';
                }
                else {
                    if (options.length > this.numberDisplayed) {
                        // return options.length + ' ' + this.nSelectedText + ' <i class="ion ion-ios-arrow-down"></i>';
                        return ' ' + this.nSelectedText + ' <i class="ion ion-ios-arrow-down"></i>';
                    }
                    else {
                        var selected = '';
                        ...
                        return selected.substr(0, selected.length - 2) + ' <i class="ion ion-ios-arrow-down"></i>';
                    }
                }
            },
            /**
            ...
            nonSelectedText: 'Public',
            nSelectedText: 'Public',
            numberDisplayed: 1
        },
