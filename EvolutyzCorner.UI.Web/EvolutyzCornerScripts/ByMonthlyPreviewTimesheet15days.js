...
//var TSID; var cid = ""; var RoleStar = $("p#PFname").next("p").text().toUpperCase();
                                    ...
                                    "render": function (TimesheetID, type, full, meta) {
                                        if ((full.TimesheetApprovalStatus == 'Saved Timesheet') || (full.TimesheetApprovalStatus == 'Rejected') || (full.TimesheetApprovalStatus == 'Rejected at Level_1 Manager') || (full.TimesheetApprovalStatus == 'Rejected at Level_2 Manager') || (full.TimesheetApprovalStatus == 'Rejected at Admin')) {
                                            ...
                                            return '<a class="btn btn-icn"   data-MonthYear="' + full.Month_Year +
                                                ...
                                                '"   onclick="EditUserByWeekly(this,' + full.ProjectId + ')" ><i  class="fa fa-edit" title="Edit"></i></a>';
                                        }
                                        else {
                                            return '<a class="btn btn-icn"  id="PreviewManagerUser"   data-MonthYear="' + full.Month_Year +
                                                ...
                                                '"  onclick="ByMonthlyPreviewSubmitTimesheet(this,' + full.ProjectId + ')" ><i class="fa fa-eye"></i></a>';
                                        }
                                    },
                                },
                            ]
                                    ...
                                    "render": function (TimesheetID, type, full, meta) {
                                        if ((full.TimesheetApprovalStatus == 'Saved Timesheet') || (full.TimesheetApprovalStatus == 'Rejected') || (full.TimesheetApprovalStatus == 'Rejected at Level_1 Manager') || (full.TimesheetApprovalStatus == 'Rejected at Level_2 Manager') || (full.TimesheetApprovalStatus == 'Revoked at Admin')) {
                                            ...
                                            return '<a class="btn btn-icn" id="PreviewUser"   data-MonthYear="' + full.Month_Year +
                                                ...
                                                '"  data-ByMonthlyDates="' + full.ByMonthlyDates +
                                                '"data-ClientprojectId="' + full.ClientprojectId +
                                                '" title="Preview"  onclick="ByMonthlyPreviewSubmitTimesheet(this,' + full.ProjectId + ')" data-TimesheetMonth="' + full.TimeSheetMonth + '" ><i class="fa fa-eye"></i></a>';
...
function EditUserByWeekly(id,proj_id) {
    ...
    $.ajax({
        ...
        data: {
            ...
            Projectid: proj_id, ClientProjectId: cid
        },
        contentType: 'application/json; charset=utf-8',
        dataType: 'JSON',
        async: false,
        success: function (resultData) {
            ...
            PreviewByMonthlyLoadHoursWorkedAcctoDate(tsuserid, Timesheetmonarray3[0], Timesheetmonarray3[1], SessionAccountid, proj_id);
...
function ByMonthlyPreviewSubmitTimesheet(id,proj_id) {
    ...
    $.ajax({
        ...
        data: {
            ...
            TimesheetEnddate: Timesheetmonarray4[1],
        ...
        success: function (resultData) {
            ...
            resultDataArray = resultData.timeSheetDetails;
            resultDataArrayUploadimages = resultData.UploadTimesheetimage;
            PreviewByMonthlyLoadHoursWorkedAcctoDate(tsuserid, Timesheetmonarray4[0], Timesheetmonarray4[1], SessionAccountid, proj_id);
...
$("body").on("click", "#btnpdf", function () {
   // $("#images").hide();
    ...
    //$("input#btnclose").hide();
    //$("input#btnclose").nextAll("button[type='submit']").hide();
