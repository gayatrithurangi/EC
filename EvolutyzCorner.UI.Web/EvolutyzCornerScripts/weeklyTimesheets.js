...
var tsuserid = '', AppRejectstatus = ''; var TimesheetID = ''; var colourcode = ''; var resultDataArrayUploadimages = '';
var clientPrjid = ""; var xclientid;
...
$(document).ready(function () {
    ...
    clientPrjid = ClientProjectid;
    xclientid = ClientProjectid;
...
function CheckTimesheetexits() {
    ...
    $.ajax({
        ...
        data: { timesheetstartdate: Timesheetmonarray1[0], timesheetenddate: Timesheetmonarray1[1], clientprojid: clientPrjid },
        datatype: "Json",
        async: false,
        success: function (data) {
...
function LoadsubmittedBymonthlyTimesheets(MonthTimesheet) {
    ...
    $.ajax({
        url: "/Timesheet/ViewByWeeklySubmitedTimesheet",
        type: "GET",
        data: { TimesheetUserid: SessionUsrid, Timesheetstartdate: Timesheetmonarray2[0], TimesheetEnddate: Timesheetmonarray2[1], Accountid: SessionAccountid, Projectid: SessionProjectid, ClientProjectId: clientPrjid},
        contentType: 'application/json; charset=utf-8',
        dataType: 'JSON',
        async: false,
        // cache: false,
