/// <reference path="bymonthlypreviewtimesheet.js" />
...
var ByMonthlystartdate = ''; var ByMonthlyenddate = ''; var colourcode = ''; var resultDataArrayUploadimages;
var TSID; var cid = '';
var tsmode = '';
//var RoleStar = $("p#PFname").next("p").text().toUpperCase();
                ...
                if (resultData.roleid) {
                    ...
                    if ((objUserSessionId == '1001') || (objUserSessionId == '1002') || (objUserSessionId == '1007') || (objUserSessionId === "1010") || (objUserSessionId == "1011") || (objUserSessionId == "1053")) {
                        ...
                        if ((objUserSessionId === '1007') || (objUserSessionId === "1010") || (objUserSessionId == "1011") || (objUserSessionId == "1053")) {
                            ...
                            $("#UserGridDataWeekly").attr("style", "display: none;");
                            //$("#ManagerGridData").attr("style", "display: table;");
                        ...
                        if (resultData.mytimesheets) {
                            ...
                            var objUsertimesheets4 = resultData.mytimesheets;
                            $('#UserGridDataWeekly').DataTable({
                                // 'destroy': true,
                                'data': objUsertimesheets4,
                                'paginate': true,
                                'sort': true,
                                'Processing': true,
                                'columns': [
                                            ...
                                            if (full.TimesheetMode === "1") {
                                                if (full.TimesheetApprovalStatus === 'Saved Timesheet' || full.TimesheetApprovalStatus === 'Rejected' || full.TimesheetApprovalStatus === 'Rejected at Level_1 Manager' || full.TimesheetApprovalStatus === 'Rejected at Level_2 Manager' || full.TimesheetApprovalStatus === 'Rejected at Admin') {
                                                    return '<a class="btn btn-icn"   data-MonthYear="' + full.Month_Year +
                                                        ...
                                                        '"  onclick="EditUserWeekly(this)" ><i  class="fa fa-edit" title="Edit"></i></a>';
                                                }
                                                else {
                                                    return '<a class="btn btn-icn"  id="PreviewManagerUser"   data-MonthYear="' + full.Month_Year +
                                                        ...
                                                        '"  onclick="PreviewSubmitTimesheetWeekly(this,' + full.TimesheetMode + ')" ><i class="fa fa-eye"></i></a>';
                                                }
                                            }

                                            if (full.TimesheetMode === "2") {
                        ...
                        $("#UserGridDataWeekly").attr("style", "display: table;");
                        $("#ManagerGridPanel").attr("style", "display: none;");
                        if (resultData.mytimesheets) {

                            var objUsertimesheets5 = resultData.mytimesheets;

                            $('#UserGridDataWeekly').DataTable({
                                // 'destroy': true,
                                'data': objUsertimesheets5,
                                'paginate': true,
                                'sort': true,
                                'Processing': true,
                                'columns': [
                                            ...
                                            if (full.TimesheetMode == 3) {
                                                if ((full.TimesheetApprovalStatus === 'Saved Timesheet') || (full.TimesheetApprovalStatus === 'Rejected') || (full.TimesheetApprovalStatus == 'Rejected at Level_1 Manager') || (full.TimesheetApprovalStatus == 'Rejected at Level_2 Manager') || (full.TimesheetApprovalStatus == 'Revoked at Admin')) {
                                                    ...
                                                    return '<a class="btn btn-icn" id="PreviewUser"   data-MonthYear="' + full.Month_Year +
                                                        ...
                                                        '"  data-ByMonthlyDates="' + full.ByMonthlyDates +
                                                        '"  data-TimesheetMode="' + full.TimesheetMode +
                                                        '"  title="Preview"  onclick="PreviewSubmitTimesheetWeekly(this,' + full.TimesheetMode + ')" data-TimesheetMonth="' + full.TimeSheetMonth + '" ><i class="fa fa-eye"></i></a>';

                                                }
                                            }

                                            else if (full.TimesheetMode == 2) {
    ...
    function PreviewSubmitTimesheetWeekly(id, mode) {
    ...
    function ManagerApprOrRejWeekly(id) {
        ...
        empactualhrs = id.getAttribute("data-CompanyBillingHours");
        empworkedhrs = id.getAttribute("data-ResourceWorkingHours");
        ByMonthlydates = ByMonthlydates.replace('-', ' to ');
        ...
        if (id == 3) {
            ...
            $("#ProjectNameid").html("Do you want to approve <b> " + empname + "'s </b>timesheets within <b>" + empworkedhrs + "</b> hours for duration <b>" + ByMonthlydates + "</b> ");
        }
        if (id == 4) {
            $("#btnRej").show();
            $("#btnAdd").hide();
            $('#PopupAppRejId').html("Reject Timesheet");
            $("#ProjectNameid").html("Do you want to reject <b> " + empname + "'s </b>timesheets within <b>" + empworkedhrs + "</b> hours for duration <b>" + ByMonthlydates + "</b> ");
        }
    ...
    function WeeklyManagerApprOrRejbFromWeb(id) {

        ByMonthlydates = $("#Timesheet_Duration").html();
        var ByMonthlydates = ByMonthlydates.replace('-', ' to ');
