...
$(document).ready(function (e)
{
    ...
    //            $(image).attr('data-target', '#imgModal');
    //            image.title = file.name;
    ...
    //document.querySelector('#flImage').addEventListener("change", previewImages);

    //$('a#images.kin > img').on('click', function () {
