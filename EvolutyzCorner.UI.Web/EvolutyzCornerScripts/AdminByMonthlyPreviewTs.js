                                ...
                                },
                                {
                                    "render": function (TimesheetID, type, full, meta) {
                                        if ((full.TimesheetApprovalStatus == 'Saved Timesheet') || (full.TimesheetApprovalStatus == 'Rejected') || (full.TimesheetApprovalStatus == 'Rejected at Level_1 Manager') || (full.TimesheetApprovalStatus == 'Rejected at Level_2 Manager') || (full.TimesheetApprovalStatus == 'Rejected at Admin')) {
                                            ...
                                            return '<a class="btn btn-icn"  id="PreviewManagerUser"   data-MonthYear="' + full.Month_Year + '" data-TimesheetID="' + full.TimesheetID + '" data-TimesheetID="' + full.TimesheetID + '" data-ProjectId="' + full.ProjectId + '" data-Usr_UserID="' + full.Usr_UserID + '" data-ByMonthlyDates="' + full.ByMonthlyDates + '"  data-TimesheetMonth="' + full.TimeSheetMonth + '" title="Preview" data-TimesheetApprovalStatus="' + full.TimesheetApprovalStatus + '"  onclick="ByWeeklyPreviewSubmitTimesheet(this)" ><i class="fa fa-eye"></i></a>';
                                        }
                                    },
                                },
                            ]
                                ...
                                },
                                {
                                    "render": function (TimesheetID, type, full, meta) {
                                        if ((full.TimesheetApprovalStatus == 'Saved Timesheet') || (full.TimesheetApprovalStatus == 'Rejected') || (full.TimesheetApprovalStatus == 'Rejected at Level_1 Manager') || (full.TimesheetApprovalStatus == 'Rejected at Level_2 Manager') || (full.TimesheetApprovalStatus == 'Revoked at Admin')) {
                                            return '<a class="btn btn-icn"   data-MonthYear="' + full.Month_Year + '" data-TimesheetID="' + full.TimesheetID + '"  data-Usr_UserID="' + full.Usr_UserID + '" data-ProjectId="' + full.ProjectId + '" data-ByMonthlyDates="' + full.ByMonthlyDates + '" data-TimesheetMonth="' + full.TimeSheetMonth + '" onclick="EditUserByWeekly(this)" ><i class="fa fa-edit" title="Edit"></i></a>';
                                        }

                                        else {

                                            return '<a class="btn btn-icn" id="PreviewUser"   data-MonthYear="' + full.Month_Year + '" data-TimesheetID="' + full.TimesheetID + '" data-Usr_UserID="' + full.Usr_UserID + '" data-ProjectId="' + full.ProjectId + '"  data-ByMonthlyDates="' + full.ByMonthlyDates + '" title="Preview"  onclick="ByWeeklyPreviewSubmitTimesheet(this)" data-TimesheetMonth="' + full.TimeSheetMonth + '" ><i class="fa fa-eye"></i></a>';
...
var TaskDetailsid = ''; var MonthTimesheet = ''; var TimesheetMonth; var tsuserid = '', AppRejectstatus = ''; var ByMonthlydates = '';
function EditUserByWeekly(id) {
    ...
    $.ajax({
        ...
        type: "GET",
        data: { TimesheetUserid: tsuserid, Timesheetstartdate: Timesheetmonarray3[0], TimesheetEnddate: Timesheetmonarray3[1], Accountid: SessionAccountid, Projectid: SessionProjectid },
        contentType: 'application/json; charset=utf-8',
        dataType: 'JSON',
        async: false,
        success: function (resultData) {
...
function ByWeeklyPreviewManagerSubmitTimesheet(id) {
    ...
    $.ajax({
        url: "/Timesheet/ViewByWeeklySubmitedTimesheet",
        type: "GET",
        data: { TimesheetUserid: tsuserid, Timesheetstartdate: Timesheetmonarray5[0],
            TimesheetEnddate: Timesheetmonarray5[1], Accountid: SessionAccountid, Projectid: SessionProjectid },
        contentType: 'application/json; charset=utf-8',
        dataType: 'JSON',
        async: false,
        success: function (resultData) {
...
function ViewTimesheetByWeekly(MonthTimesheet, resultData) {
    ...
    //});
    //for (var i = 0; i <= resultDataArrayUploadimages.length - 1 ; i++ ) {
    if (resultDataArrayUploadimages[0] == null) {
        $('#imgLogo').show();
        $("#images").show();
        //$('#imgLogo').prop('src', url);
